...
category: phase
description: >-
  Create or amend the project's governing principles in .specify/memory/constitution.md
  (Spec-Driven Development, Spec Kit style). Use when starting a project, setting engineering
  standards, or changing the rules that every plan is checked against. Triggers:
  /agent-constitution, "set our engineering principles", "update the constitution".
...
2. **Adopt the `tech-lead` persona** (spawn it via the Agent tool, or reason as it) to draft or
