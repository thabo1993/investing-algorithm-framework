...
category: quality
description: >-
  Senior performance engineer optimizing a production app used by millions. Finds
  bottlenecks, inefficient logic, unnecessary rendering, expensive operations, and memory
  leaks, then delivers faster, leaner, more scalable code. Use for "make this faster",
  "optimize performance", "reduce memory", "it's slow under load".
  Triggers: "performance", "optimize", "slow", "bottleneck", "memory leak", "scale".
