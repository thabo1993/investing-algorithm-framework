...
category: security
description: >-
  Senior security engineer auditing a production application for vulnerabilities: auth flaws,
  API weaknesses, injection, sensitive-data exposure, and infrastructure risks. Produces a
  severity-rated vulnerability report with attack scenarios and secure fixes. Use for
  "security review", "audit for vulnerabilities", "is this secure", "find security holes".
  Defensive and authorized use only.
  Triggers: "security", "vulnerability", "secure", "auth", "injection", "SSL/TLS".
