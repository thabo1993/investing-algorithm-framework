...
description: >-
  Senior frontend engineer building production-grade UI systems: reusable components,
  scalable component architecture, and accessible interfaces that handle loading, empty,
  and error states. Use for "build a component", "design the UI architecture", "make this
  accessible/responsive", "frontend system for production".
  Triggers: "build component", "UI architecture", "accessible", "responsive", "frontend", "React", "Vue".
