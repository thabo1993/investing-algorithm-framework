---
name: skillsmith
description: Build consistent skills using standardized syntax and guided workflows. Meta-skill for creating and maintaining skills — discover, scaffold, distill, and audit.
license: MIT
compatibility: opencode
metadata:
  version: 1.0.0
  author: Chris AI Systems
---

<activation>
## What
Meta-skill for creating and maintaining skills. Guides you through discovery (what to build), scaffolding (generating compliant files), distilling (chunking source material), and auditing (checking compliance) using standardized syntax specs.
