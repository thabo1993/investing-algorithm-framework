---
name: agent-clarify
description: Resolve [NEEDS CLARIFICATION] markers and hidden ambiguities in a spec BEFORE planning, by asking the user the questions whose answers change the design.
---
