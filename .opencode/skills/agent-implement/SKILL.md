...
description: Execute tasks.md to build the feature per the spec and plan, phase by phase, with checkpoints — then run the specialist polish pass (security, performance, deploy).
---
...
4. **Polish phase — delegate to specialists** (spawn via the Task tool):
