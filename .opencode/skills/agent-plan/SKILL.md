---
name: agent-plan
description: Turn an approved spec into a technical implementation plan (the HOW) — tech context, constitution check, architecture, data model, contracts, research. Executed by the architect agents.
---
...
- UI-led feature → **`ux-designer`** has already produced `design.md` (wireframes, component map,
  ...
  design, not past it.
Spawn the chosen agent via the Task tool, feeding it `spec.md` + `design.md` + `design-system/MASTER.md` (if they exist).
