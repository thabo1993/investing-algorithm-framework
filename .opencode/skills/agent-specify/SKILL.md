---
name: agent-specify
description: Turn a feature idea into a formal spec.md (the WHAT and WHY — user stories, requirements, acceptance criteria) using the Spec Kit spec template. No tech, no code. Use to start a new feature.
---
